...
class NuPICPlotOutput(NuPICOutput):
  ...
  def initializeLines(self, timestamp):
    ...
    # Location upper left = 2
    self._mainGraph.legend(tuple(['actual', 'predicted']), loc=2)
